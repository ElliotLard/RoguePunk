...
public class TestInvoker
{
	...
	/**
	 * Test Initialization of Invoker. Should
	 * be a singleton.
	 * 
	 * game value is null because we don't need to instantiate
	 * a game for this test.
	 */
	@Test
	public void testInit()
	{
		...
		assertTrue(invoke1 == invoke2); // Should be equal to each other because only one invoker
		
		InvokerBuilder.destroyInvoker(); // Since it's a Singleton, we must destroy it when we are done.
	}
	
	/**
	 * Testing key inputs to use player commands for movement
	 * We are using WASD movement because the arrow key values
	 * do not seem universal.
	 */
	@Test
	...
	/**
	 * We'd have to isntantiate the game and basically run it to test
	 * and that's a lot to do. Instead we're using a dialogue box to ask
	 * if it has worked or not when used in the game.
	 */
	@Test
