...
/**
 * 
 * @author Christopher Wilson Class provides base stats and characteristics of
 *         all LifeForms in the game.
 *
 */
public abstract class LifeForm implements RoundObserver, Displayable
{
	 ...
	 * @param speed
	 */
	public LifeForm(String name, char r, Item h, Item t, Item a, Item l)
	{
	...
	/**
	 * Once items are implemented we will use this method to update stats.
	 */
